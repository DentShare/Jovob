...
const t = {
  ru: {
    ...
    igLabel: "Instagram",
    igDesc: "Direct сообщения через Meta Graph API",
    waLabel: "WhatsApp",
    waDesc: "WhatsApp Business Cloud API",
    msgLabel: "Messenger",
  ...
  uz: {
    ...
    igLabel: "Instagram",
    igDesc: "Meta Graph API orqali Direct xabarlar",
    waLabel: "WhatsApp",
    waDesc: "WhatsApp Business Cloud API",
    msgLabel: "Messenger",
  ...
  en: {
    ...
    igLabel: "Instagram",
    igDesc: "Direct messages via Meta Graph API",
    waLabel: "WhatsApp",
    waDesc: "WhatsApp Business Cloud API",
    msgLabel: "Messenger",
...
const metaPlatforms = [
  {
    ...
    labelKey: "igLabel" as const,
    descKey: "igDesc" as const,
  ...
  },
  {
    ...
    labelKey: "msgLabel" as const,
    descKey: "msgDesc" as const,
    gradient: "from-blue-500 to-blue-600",
    icon: (
      <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.497 1.745 6.616 4.472 8.652V24l4.086-2.242c1.09.301 2.246.464 3.442.464 6.627 0 12-4.974 12-11.111S18.627 0 12 0zm1.193 14.963l-3.056-3.259-5.963 3.259L10.732 8.2l3.131 3.259 5.888-3.259-6.558 6.763z" />
      </svg>
    ),
  },
  {
    key: "whatsapp" as const,
    labelKey: "waLabel" as const,
    descKey: "waDesc" as const,
  ...
  return (
    <div>
      ...
      <div className="max-w-lg mx-auto space-y-4">
        ...
        {/* Meta platforms (Instagram, Messenger, WhatsApp) */}
        {metaPlatforms.map((platform, i) => (
          <motion.div
            key={platform.key}
            className="bg-white rounded-2xl border-2 border-slate-200 p-5"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <span className="font-semibold text-slate-800">{texts[platform.labelKey]}</span>
                  <span className="text-xs bg-green-100 text-green-600 px-2 py-0.5 rounded-full font-medium">
                    {texts.available}
                  </span>
                </div>
                <p className="text-xs text-slate-400 mt-0.5">{texts[platform.descKey]}</p>
              </div>
              <span className="text-xs text-slate-400 border border-slate-200 px-3 py-1 rounded-lg whitespace-nowrap">
                {texts.connectFromDashboard}
              </span>
            </div>
          </motion.div>
        ))}

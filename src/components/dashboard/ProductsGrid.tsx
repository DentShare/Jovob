...
const categories = ["Все", "Розы", "Тюльпаны", "Букеты", "Аксессуары"];
        ...
        <div className="mb-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <input
              ...
              className="rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-[#3B82F6] focus:outline-none focus:ring-1 focus:ring-[#3B82F6]"
            />
            <select className="rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-700 focus:border-[#3B82F6] focus:outline-none focus:ring-1 focus:ring-[#3B82F6]">
          ...
          >
            ...
            <div className={`relative flex h-40 items-center justify-center ${colorPalette[index % colorPalette.length].split(" ")[0]}`}>
              ...
              <div className="absolute right-2 top-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                <button className="rounded-lg bg-white/90 p-1.5 text-gray-600 hover:bg-white shadow-sm">
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                  </svg>
                </button>
                <button className="rounded-lg bg-white/90 p-1.5 text-red-500 hover:bg-white shadow-sm">
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
